%*****Author : Yann Lafaille + I collaborated with Martin Boyer on this
%algorithm*****
...
%modification at line 270 "if  isd == 3 la1k(k) =
%min(eig(Hk(2*k-1:2*k,:))); end" because it didn't worked with the original
%version
